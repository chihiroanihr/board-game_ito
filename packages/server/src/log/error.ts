 ...
 *
 * @param {unknown} error - The original error caught during execution. This can be of any type, but if it's an instance of Error, its message will be used.
 ...
 *
 * @param {unknown} error - The original error (from database query execution) that was caught. Can be of any type, but if it's an instance of Error, its message and stack trace will be used.
